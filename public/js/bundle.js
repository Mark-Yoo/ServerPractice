...
(function () {
  ...
  var $btn = document.querySelector('.clear-completed > .btn');
  var $completedTodo = document.querySelector('.completed-todos');
  ...
  function render(resTodo) {
    ...
    function addHTML(todosList) {
      var newhtml = '';
      todosList.forEach(function (_ref) {
        var id = _ref.id,
            content = _ref.content,
            completed = _ref.completed;
        newhtml += "<li id=\"".concat(id, "\" class=\"todo-item\"><input class=\"custom-checkbox\" type=\"checkbox\" ").concat(completed ? 'checked' : '', " id= \"ck-").concat(id, "\"><label for=\"ck-").concat(id, "\">").concat(content, "</label><i class=\"remove-todo far fa-times-circle\"></i></li>");
      });
      return newhtml;
    }
    ...
    if (navId === 'all') {
      ...
      html = addHTML(todos.filter(function (_ref2) {
        var completed = _ref2.completed;
        return navId === 'active' ? !completed : completed;
      }));
    }

    $todos.innerHTML = html;
    $completedTodo.innerHTML = todos.filter(function (_ref3) {
      var completed = _ref3.completed;
      return completed;
    }).length;
    $activeTodos.innerHTML = todos.filter(function (_ref4) {
